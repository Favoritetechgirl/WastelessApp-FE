    ...
    <div className='h-screen w-screen flex items-start'>
      ...
      <div className='w-3/12 h-screen border-r-2 border-gray-300'>
        ...
        <div className='p-5'>
          <ul>
            <li className='mb-5'>
              <button className={`${location == 'inv' ? 'text-green-600' : ''} text-gray-500 text-lg flex gap-3 items-center font-semibold`}>
                <Store />
                Inventory
              </button>
            </li>
            ...
            <li className='mb-5'>
              <button className={`${location == 'rec' ? 'text-green-600' : ''} text-gray-500 text-lg flex gap-3 items-center font-semibold`}>
                <CookingPot />
                Recipe
              </button>
            </li>
            ...
            <li className='mb-5'>
              <button className={`${location == 'imp' ? 'text-green-600' : ''} text-gray-500 text-lg flex gap-3 items-center font-semibold`}>
                <Trophy />
                Impact
              </button>
            </li>
            ...
            <li>
              <button className={`${location == 'set' ? 'text-green-600' : ''} text-gray-500 text-lg flex gap-3 items-center font-semibold`}>
                <Settings />
                Settings
              </button>
            </li>
