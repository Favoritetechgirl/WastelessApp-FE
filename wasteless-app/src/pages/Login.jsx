            ...
            <div className="px-6 mt-6">
                ...
                <div className="flex items-center bg-white border rounded-full mt-1 px-4 py-3 relative">
                    ...
                    <input
                        ...
                        className="flex-1 ml-3 outline-none text-sm"
                    />
                    <span className="text-xs text-gray-500 absolute right-4 top-3">
                        👁
                    </span>
                </div>

                <div className="w-full flex justify-end mt-1 mb-4">
                    <Link to="/forgot-password" className="text-xs text-gray-600">
                        Forgot password?
                    </Link>
                </div>

                {/* Log In Button */}
                <button className="w-full bg-green-600 text-white rounded-full py-3 font-semibold">
                    Log in
                </button>
